...
// Set all calendars to start at surveyDate and display sequential months from there
calendars.forEach((calendar, index) => {
    // Set the initial display month to surveyDate for each calendar
    ...
    calendar.value(currentMonthDate); // Set the value to force the initial display
